...
export const Navigation: React.FC<NavigationProps> = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <aside className="w-full md:w-64 md:min-h-screen bg-[#0a120e] border-r border-emerald-500/15 flex flex-col justify-between p-4 md:p-6 select-none z-30">
      {/* Brand Header */}
      <div>
        <div className="flex items-center gap-3 px-2 py-2 mb-8">
          <div className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-emerald-600 to-teal-400 p-0.5 shadow-glow-sm">
      ...
      <div className="mt-6 pt-5 border-t border-emerald-950 space-y-4">
        ...
        <button
          ...
          className="w-full py-2.5 px-3 rounded-xl bg-emerald-900/40 hover:bg-emerald-800/60 border border-emerald-500/25 text-emerald-200 text-xs font-semibold flex items-center justify-center gap-2 transition-all"
        >
